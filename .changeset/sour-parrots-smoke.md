...
The limiter's ceiling also drops from -1 to -2 dBFS. Ratio maxes out at 20 on this node rather than being a brick wall, so peaks above the threshold still pass a twentieth of their excess; the old ceiling left no room for that.
