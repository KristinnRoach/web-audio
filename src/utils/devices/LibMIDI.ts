...
//     uiStuff.createSelect(
//       midiAccess.inputs.values(),
//       this.onMidiInputPortSelected.bind(this),
//       '<Select an Input device>'
//     ); // here this.onMidiInputPortSelected is the select's `onchange` event callback function
...
//       this.onMidiOutputPortSelected.bind(this),
//       '<Select an Output device>'
//     ); // here this.onMidiOutputPortSelected is the select's `onchange` event callback function
//   }
